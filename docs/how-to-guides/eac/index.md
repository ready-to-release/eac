...
Other languages can use container-based or script-based builds. See [R2R and EAC Reference](../../reference/eac/architecture/component-types.md#language-support-matrix) for details.
