...
Other languages can use container-based or script-based builds. See [R2R and EAC Reference](../../reference/eac/architecture/#language-support) for details.
...
- **[R2R and EAC Reference](../../reference/eac/architecture/)** - Architecture, contracts, and extending EAC
