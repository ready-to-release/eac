<!-- EDITOR
# Editor: how-to-guides/commands/areas/pipeline-configuration.md

## Soul

Configuration reference for pipeline orchestration covering execution settings (parallel, timeout, retry), dependency handling, GitHub Actions matrix strategies, and changed module detection.
...
7. Pipeline Wait Configuration
   - Wait Command Options
8. Status Configuration
   - Status Output
9. Changed Modules Configuration
