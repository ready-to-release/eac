<!-- EDITOR
# Editor: how-to-guides/commands/areas/specifications-configuration.md

## Soul

Configuration reference for BDD specifications covering tag contracts, pattern tags (skip, env, deps, depm), AI prompt templates, test suite definitions, and validation rules.
...
4. Specification Settings
   - Global Settings
   - Module-Specific Settings
5. Step Definition Configuration
   - Step Registry
