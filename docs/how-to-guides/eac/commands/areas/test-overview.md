<!-- EDITOR
# Editor: how-to-guides/commands/areas/test-overview.md

## Soul

Unified test execution system across module types with Cucumber JSON/JUnit XML output, test suite management, coverage collection, and failure debugging support.

## Sections

1. What is the Testing System?
2. When to Use Test Commands
3. Common Use Cases
4. Key Concepts
   - Test Output Formats
   - Test Suites
