<!-- EDITOR
# Editor: how-to-guides/commands/areas/build-commands.md

## Soul

Complete command reference for `build` command with all flags, module type support, output formats, and integration patterns for local development and CI/CD.
