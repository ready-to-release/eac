...
- AI provider configured (see [Setup AI Provider](../advanced/setup-ai-provider.md))
...
- [Understanding AI Process](../advanced/understand-ai-commit-process.md) → How AI works
