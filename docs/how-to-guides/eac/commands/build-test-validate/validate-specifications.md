...
# Output:
# ✓ specs/clie/user-login/specification.feature
# ✗ specs/clie/user-registration/specification.feature
...
# {
#   "unused_steps": [
#     "go/specs/impl/clie/steps_user_login.go:25: When user clicks legacy button"
#   ]
# }
