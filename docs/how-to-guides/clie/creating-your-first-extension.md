...
**Prerequisites:** [Quick Start Guide](../../tutorials/getting-started/quick-start.md), Docker installed, basic Go knowledge
...
!!! tip "Complete Guide Available"
    ...
    - **[Creating Extensions Guide](./creating-extensions.md)** - Complete reference with production patterns
...
- **[Creating Extensions Guide](./creating-extensions.md)** - Complete patterns:
...
- **[Local Development Workflows](../local-setup/local-dev-workflows.md)** - Iterate faster
- **[Testing in External Repos](./testing-in-external-repos.md)** - Validate across projects
