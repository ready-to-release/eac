...
To understand how the AI analyzes your changes, see [AI Process Explanation](../../explanation/commands/commit-ai-process.md).
...
- **Understand the AI**: Read [AI Process Explanation](../../explanation/commands/commit-ai-process.md) to see how the 5-phase generation works
