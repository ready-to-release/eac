<!-- EDITOR
# Editor: how-to-guides/commands/areas/design-configuration.md

## Soul

Configuration reference for architecture design covering Structurizr DSL syntax (model, views, styles), themes (built-in and custom JSON), AI prompts, and Docker/MkDocs integration.

## Sections

1. Configuration Files
2. Workspace DSL Structure
   - Basic Workspace
   - Model Elements (People, Software Systems, Containers, Components)
   - Relationships
