<!-- EDITOR
# Editor: how-to-guides/commands/areas/workspace-configuration.md

## Soul

Configuration reference for workspace management including worktree path patterns, branch naming validation, merge strategies, AI commit/PR prompts, and git integration settings.
...
4. Merge Configuration
   ...
   - Rebase Merge
   - Post-Merge Cleanup
5. AI Commit Configuration
   - Prompt Templates
   - Summary Prompt
   - Module Prompt
6. AI PR Configuration
   - Prompt Templates
