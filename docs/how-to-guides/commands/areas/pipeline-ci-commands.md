<!-- EDITOR
# Editor: how-to-guides/commands/areas/pipeline-ci-commands.md

## Soul

CI diagnostic commands that generate context-rich GitHub Actions step summaries for 6 failure types (build, test, container, release, docs, deviation).
