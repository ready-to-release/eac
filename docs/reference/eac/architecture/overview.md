...
See [MCP Server Architecture](../modules/eac-mcp-commands.md) for details.
...
- [Architecture Index](./index.md) - Architecture section overview
- [Contracts](../contracts/) - Contract system and YAML schemas
- [Modules](../modules/) - Module system and types
