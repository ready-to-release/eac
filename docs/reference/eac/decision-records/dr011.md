...
1. **SemVer** (API compatibility):
   - Modules: `clie-cli`, `eac-ext`, `eac-cli`, `eac-mcp-server`, `implicit-cli`, `clie-installer`, `vscode-commit`
...
- Format: `clie-(clie_version) ∞ eac-(eac_version)`
- Example: `clie-(0.0.24) ∞ eac-(0.0.15)`
