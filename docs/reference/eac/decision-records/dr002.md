...
- **SemVer** (code artifacts with API contracts): clie, eac-ext, eac, eac-mcp-server, implicit-cli, clie-installer, vscode-commit
...
**Git Tags**: `<module>-v<version>` (e.g., `clie-v0.0.24`, `docs-v2025.12`)
