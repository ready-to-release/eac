...
- **SemVer** (code artifacts with API contracts): clie-cli, eac-ext, eac-cli, eac-mcp-server, implicit-cli, clie-installer, vscode-commit
...
- **SemVer for Bundles**: clie-eac-bundle
...
**Release Bundles**: CalVer-versioned aggregates combining multiple module versions (e.g., `clie-(clie_version) ∞ eac-(eac_version)`)

**Commit Format**: `<module>: <type>: <description>` (e.g., `cli: feat: add command`)

**Git Tags**: `<module>-v<version>` (e.g., `clie-cli-v0.0.24`, `docs-v2025.12`)
