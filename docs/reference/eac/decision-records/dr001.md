...
**Module Contracts**: Modules defined in `.eac/repository.yml` with YAML contracts specifying components, dependencies, and versioning (e.g., eac-core, eac-commands, clie-cli, eac-ext, docs, books)
