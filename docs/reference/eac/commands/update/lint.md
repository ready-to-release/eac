...
- **Go modules** use [golangci-lint](./lint/go.md)
- **Static/docs modules** use [markdownlint-cli2](./lint/markdown.md)
...
- [update lint (Go)](./lint/go.md) - Go linting details
- [update lint (Markdown)](./lint/markdown.md) - Markdown linting details
