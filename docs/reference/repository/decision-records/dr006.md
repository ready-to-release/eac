...
**Command Categories** (`.eac/commands.yml`):
...
- Commands exposed as MCP tools via `go/mcp/commands`
...
- `validate-specs` → `docs/reference/eac/commands/validate/specs.md`
- `create pr` → `docs/reference/eac/commands/create/pr.md`
- `work create` → `docs/reference/eac/commands/work/create.md`
