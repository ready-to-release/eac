...
**Module Contracts**: Modules defined in `.r2r/eac/repository.yml` with YAML contracts specifying components, dependencies, and versioning (e.g., eac-core, eac-commands, r2r-cli, ext-eac, docs, books)
