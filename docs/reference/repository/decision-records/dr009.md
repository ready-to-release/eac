...
- **Go**: CLI tools, libraries, MCP servers (`go/cli/`, `go/core/`, `go/mcp/`, `go/r2r/`)
...
- **Python**: Specialized tooling, diagram processing (`containers/drawio-tool/*.py`)

**Cross-Platform Strategy**:

- PowerShell + Shell for portability
- Same functionality, platform-specific implementation
- Examples: `r2r-installer`, `implicit-cli`
