...
**Component Types**: Many types (go, typescript, dockerfile, book, workflows, gherkin, structurizr, bash, pwsh, markdown, json, yaml) defined in `contracts/eac-core/0.1.0/defaults/component-types.yml`
...
**Module Registry**: `.r2r/eac/repository.yml` with modules forming a dependency graph
