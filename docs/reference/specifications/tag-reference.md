...
**Note:** Depending on the context you work in, you might need additional tags to support specific regulatory requirements. See [GxP Tagging](../../explanation/specifications/gxp-tagging.md) as an example.

---

## Test Level Tags

Test level tags define the execution environment and scope based on the [Testing Taxonomy](../../explanation/continuous-delivery/testing/index.md).
...
See [Risk Controls](../../explanation/specifications/risk-controls.md) for complete documentation.
...
- [Testing Strategy Overview](../../explanation/continuous-delivery/testing/testing-strategy-overview.md) - Test taxonomy and levels
- [Testing Strategy Integration](../../explanation/continuous-delivery/testing/testing-strategy-integration.md) - Test levels by CD Model stage
- [Gherkin Concepts](../../explanation/specifications/gherkin-concepts.md) - Organizing specifications with tags
- [Risk Controls](../../explanation/specifications/risk-controls.md) - Risk control tagging for compliance
- [Three-Layer Approach](../../explanation/specifications/three-layer-approach.md) - Rule/Scenario/Unit Test integration
