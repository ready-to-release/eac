<!-- EDITOR
# Editor: reference/decision-records/dr002.md

## Soul

ADR establishing semantic versioning with trunk-based development, defining commit format, tag format, and automated version bump rules.
