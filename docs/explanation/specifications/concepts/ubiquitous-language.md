...
**See**: [Event Storming](../discovery/event-storming-overview.md) for workshop formats, facilitation, and best practices.
...
**See**: [Example Mapping](../discovery/example-mapping.md) for detailed workshop process.
