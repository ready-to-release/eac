...
> **OSCAL-based control management with automated evidence collection**
...
- Standardized format (NIST OSCAL 1.1.3)

---

## OSCAL Architecture

EAC uses the [OSCAL (Open Security Controls Assessment Language)](https://pages.nist.gov/OSCAL/) standard for control management.
...
### 1. OSCAL Catalog (Templates)

**What**: Library of standard control definitions (e.g., NIST 800-53, ISO 27001)
...
### 2. OSCAL Profile (Your Selection)
...
### 3. BDD Specifications (Your Implementation)
...
### 4. Assessment Results (Automated Evidence)
...
```bash
create risk-assess --profile specs/.risk-controls/<module>.profile.json
```
...
The OSCAL catalog includes NIST 800-53 Rev 5 controls:
...
Common frameworks map to NIST 800-53 controls:
...
**Note**: Always engage qualified compliance personnel to validate control mappings for your specific regulatory obligations.
