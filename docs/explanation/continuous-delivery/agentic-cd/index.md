...
This documentation is based on the ACD framework by Bryan Finster. For the canonical definitions, see the [Agentic CD source](https://migration.minimumcd.org/docs/agentic-cd/).
