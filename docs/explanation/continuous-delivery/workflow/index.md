...
| Topic                                                 | Description                                  |
| ----------------------------------------------------- | -------------------------------------------- |
| [Trunk-Based Development](trunk-based-development.md) | Core principles for continuous integration   |
| [Branch Types](branch-types.md)                       | Trunk, topic, and release branch definitions |
