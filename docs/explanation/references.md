...
![Accelerate](../assets/references/accelerate.png){ width="150" }

> Forsgren, Nicole and Humble, Jez and Kim, Gene (2018).

### The DevOps Handbook

![The DevOps Handbook](../assets/references/devopshandbook.png){ width="150" }

> Gene Kim, Jez Humble, Patrick Debois, John Willis, Nicole Forsgren (2021).

### Continuous Delivery

![Continuous Delivery](../assets/references/cdbook.png){ width="150" }
...
![Effective Behavior-Driven Development](../assets/references/effective-bdd-development.png){ width="150" }
...
![State of DevOps](../assets/references/dora-state-of-devops-generic.png){ width="150" }
