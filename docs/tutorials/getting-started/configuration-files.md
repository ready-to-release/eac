...
See [CLI vs Extensions](../../reference/devex/internal/cli-vs-extensions.md) for detailed architecture explanation.
...
For complete reference, see [R2R CLI Configuration Guide](../../reference/r2r/configuration/).
