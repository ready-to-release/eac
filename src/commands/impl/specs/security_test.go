// File: src/commands/impl/specs/security_test.go
package specs
...
func TestExtractFeatureName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			gherkin:    "Feature: src-commands_user-authentication\n  As a user...",
...
func TestDetermineOutputPath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantContain: []string{"specs", "src-commands", "user-auth", "specification.feature"},
		},
		{
...
func TestExtractFeatureName_SpecialCharactersValidation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			gherkin:     "Feature: src-commands_user-auth\n",
			wantModule:  "src-commands",
			wantName:    "user-auth",
			wantErr:     false,
		...
		},
		{
			...
			gherkin:     "Feature: src/commands/test\n",
			wantModule:  "",
			wantName:    "",
...
func TestExtractFeatureName_UnicodeNames(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "Mixed scripts",
			gherkin:     "Feature: src-cli_función-中文-test\n",
			wantModule:  "src-cli",
...
func TestExtractFeatureName_WindowsReservedNames(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			gherkin:    "Feature: src-cli_console-app\n",
			wantModule: "src-cli",
...
func TestValidateFeatureLineSecurity(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			featureLine: "src-commands_user-auth",
			wantErr:     false,
		},
		{
