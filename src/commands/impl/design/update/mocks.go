// Package update provides the design update subcommand.
//
// This file contains mock infrastructure for testing the design update command.
// It follows the same pattern as the create command's mocks.go.
package update
