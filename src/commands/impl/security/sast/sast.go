...
func printSASTUsage() {
	...
	log.Info("  security sast src-core                 # Single module")
	log.Info("  security sast src-core src-cli         # Multiple modules")
	...
	log.Info("  security sast src-core --debug         # Debug logging")
	log.Info("")
	log.Info("Output:")
