...
func TestSemgrepMockOutput(t *testing.T) {
	...
	SetMockSemgrepOutput(mockData)
	defer ResetMockSemgrepOutput()
...
func TestZAPMockOutput(t *testing.T) {
	...
	SetMockZAPOutput(mockData)
	defer ResetMockZAPOutput()
...
func TestResetMocks(t *testing.T) {
	// Set all mocks
	SetMockTrivyOutput(map[string]interface{}{"test": "trivy"})
	SetMockSemgrepOutput(map[string]interface{}{"test": "semgrep"})
	SetMockZAPOutput(map[string]interface{}{"test": "zap"})
