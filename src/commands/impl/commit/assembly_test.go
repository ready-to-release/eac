...
func TestCombineCommitSections_Deduplication(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			moduleSections: []string{
				"src-core\n--------\nsrc-core: feat: first change",
				"contracts\n---------\ncontracts: feat: update contracts",
				"src-core\n--------\nsrc-core: feat: second change (duplicate)",
			},
			wantModules: []string{
				"src-core",
				"contracts",
		...
		},
		{
			...
			moduleSections: []string{
				"src-cli\n--------\nsrc-cli: fix: resolve issue",
				"src-core\n---------\nsrc-core: fix: fix bug",
			},
			wantModules: []string{
				"src-cli",
				"src-core",
		...
		},
		{
			...
			moduleSections: []string{
				"src-commands\n------------\nsrc-commands: feat: add command 1",
				"src-commands\n------------\nsrc-commands: feat: add command 2",
				"src-commands\n------------\nsrc-commands: feat: add command 3",
			},
			wantModules: []string{
				"src-commands",
			},
