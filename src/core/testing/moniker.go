...
// Example: src-cli_install-test_TestInstallCommand-CreateConfigFile
func generateGoTestMoniker(testRef TestReference, module string) string {
	// Extract test file name without extension
	// Path: C:\projects\eac\src\cli\cmd\install_test.go
	// File: install_test
...
// specs/src-cli/cli-invocation/specification.feature -> cli-invocation
...
// C:\projects\eac\src\cli\cmd\install_test.go -> install-test
