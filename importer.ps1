...
# Create agent-config.personal.yml for local development with claude-cli
$PersonalConfigPath = Join-Path $PSScriptRoot ".r2r\eac\agent-config.personal.yml"
if (-not (Test-Path $PersonalConfigPath)) {
    ...
    $ConfigContent = @"
# Personal AI Configuration (Local Development)
# Generated by: importer.ps1 for development workflow
...
"@
    ...
    Write-Host "   File: .r2r\eac\agent-config.personal.yml" -ForegroundColor Gray
}
