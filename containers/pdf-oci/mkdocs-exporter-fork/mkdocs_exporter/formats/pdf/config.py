...
class BrowserConfig(BaseConfig):
  ...
  pool_size = c.Type(int, default=6)
  """Number of pre-warmed browser pages for parallel rendering."""
...
class AggregatorConfig(BaseConfig):
  ...
  merge_batch_size = c.Type(int, default=50)
  """PDFs per merge batch for parallel tree-merge (optimal for 300+ files)."""

  merge_workers = c.Type(int, default=6)
  """Number of parallel merge processes (uses ProcessPoolExecutor)."""

  book_title = c.Type(str, default='Documentation')
  """Book title for cover page and footers."""

  book_description = c.Type(str, default='')
  """Book description for cover page."""
...
class Config(BaseConfig):
  ...
  page_limit = c.Type(int, default=0)
  """Maximum pages to render (0 = unlimited). For devbox mode: 10 pages."""
