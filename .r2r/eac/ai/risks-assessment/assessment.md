...
Use `create risk-controls <this-file>` to generate risk control specifications.

## Next Steps

- [ ] Review identified risks with security team
- [ ] Create risk controls: `create risk-controls <this-file>`
...
**Generated by:** r2r create risk-assessment
**Command:** `{{.Command}}`
