...
./install.sh --version eac-cli/v1.0.0
...
```bash
wget -qO- https://raw.githubusercontent.com/ready-to-release/eac/main/scripts/sh/eac/install.sh | bash
```

## Default Install Location

- **User install**: `~/.local/bin/eac`
- **System install**: `/usr/local/bin/eac`
