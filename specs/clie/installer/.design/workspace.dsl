workspace "CLIE CLI Installer Scripts" "Cross-platform installer scripts for CLIE CLI" {

    model {
        # External systems
        user = person "Developer" "Developer installing CLIE CLI"
        github_releases = softwareSystem "GitHub Releases" "CLIE CLI release artifacts" "External"
        ...
        # Installer system
        installer = softwareSystem "CLI Installer Scripts" "Cross-platform scripts for downloading and installing CLIE CLI" {
