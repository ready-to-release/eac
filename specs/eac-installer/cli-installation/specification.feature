...
Feature: eac-installer_cli-installation
  ...
  Rule: Installer downloads and installs CLI binary
    ...
    @ov @deps:windows @depm:eac-installer @L3
    ...
    @ov @deps:linux @deps:curl @depm:eac-installer @L3
  ...
  Rule: Installer handles errors gracefully
    ...
    @L2 @ov @deps:windows @depm:eac-installer
    ...
    @L2 @ov @deps:linux @deps:curl @depm:eac-installer
