...
Feature: eac-commands_create-risk-controls
  ...
  Rule: Command must be registered and accessible
    ...
    Scenario: Command is listed
      ...
      And I should see "create risk-controls"

    Scenario: Command shows help
      When I run "show help create risk-controls"
      Then the exit code is 0
  ...
  Rule: Command creates controls from assessment file
    ...
    Scenario: Create controls from single assessment
      ...
      When I run "create risk-controls .docs/reference/assessment.md"
      Then the exit code is 0
  ...
  Rule: Command uses create spec internally

    Scenario: Calls create spec for each risk
      Given the assessment contains 2 risks
      When I run "create risk-controls .docs/reference/assessment.md --debug"
      Then create spec is called 2 times
      And each call includes risk description
      And debug logs show create spec invocations
  ...
  Rule: Force flag overwrites existing controls
    ...
    Scenario: Skip existing controls by default
      ...
      When I run "create risk-controls assessment.md"
  ...
  Rule: Force mode prevents orphaned tags
    ...
    Scenario: Allow force overwrite with explicit confirmation
      ...
      When I run "create risk-controls assessment.md --force --allow-orphans"
  ...
  Rule: Custom output directory supported
    ...
    Scenario: Use custom output directory (long form)
      When I run "create risk-controls assessment.md --output specs/custom/"
      Then controls are created under "specs/custom/"

    Scenario: Use custom output directory (short form)
      When I run "create risk-controls assessment.md -o specs/custom/"
      Then controls are created under "specs/custom/"

  Rule: All flags have shorthand versions

    Scenario: Short flags work
      When I run "create risk-controls assessment.md -f -o specs/custom/ -p prompt.md -D"
  ...
  Rule: Process multiple assessment files
    ...
    Scenario: Create from folder of assessments
      ...
      When I run "create risk-controls .docs/assessments/"
