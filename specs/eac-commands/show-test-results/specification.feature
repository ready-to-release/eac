...
Feature: eac-commands_show-test-results
  As a developer
  ...
  Rule: Shows per-module test breakdowns
    ...
    Scenario: Shows module duration
      Given module "eac-commands" has duration 33.1 seconds
      When I run "show test-results"
