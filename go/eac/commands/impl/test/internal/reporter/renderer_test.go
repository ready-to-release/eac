...
func TestRenderer_Render(t *testing.T) {
	tests := []struct {
		...
		},
		{
				...
				Modules: []ModuleReportData{
					{
						...
						TestResultDir: "eac-commands",
						Features: []FeatureReportData{
							{
								Name:          "Template Management",
								URI:           "../../../specs/eac-commands/templates/specification.feature",
								NormalizedURI: "specs/eac-commands/templates/specification.feature",
			...
			wantContains: []string{
				"## Module: eac-commands",
				"[Test results](./eac-commands)",
				"### Specifications (BDD Tests)",
				"[Template Management](../../specs/eac-commands/templates/specification.feature)",
				"@smoke @templates",
...
func TestNormalizeSpecPath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			uri:  "../../../specs/eac-commands/templates/specification.feature",
			want: "specs/eac-commands/templates/specification.feature",
		},
		{
			name: "adds specs/ prefix if missing",
			uri:  "eac-commands/templates/specification.feature",
			want: "specs/eac-commands/templates/specification.feature",
		},
		{
			name: "leaves correct path unchanged",
			uri:  "specs/r2r-cli/init/specification.feature",
			want: "specs/r2r-cli/init/specification.feature",
		},
	}
