...
func TestChangelogLocationValidation(t *testing.T) {
	...
	// Navigate up to repository root (from go/eac/commands/impl/validate to root)
	for i := 0; i < 5; i++ {
...
func TestSpecificModuleChangelogLocations(t *testing.T) {
	...
	internalModules := []struct {
	...
	}{
		{
			...
			expectedPath: "go/eac/commands/CHANGELOG.md",
		},
		{
		...
		},
		{
			...
			expectedPath: "typescript/vscode-ext-commit/CHANGELOG.md",
		},
	}
