...
import "github.com/ready-to-release/eac/go/eac/core/tool"
...
type ServeContext struct {
	...
	StaticSiteImage  string // e.g., "cli-static-site:latest"
...
func DefaultServeContext() *ServeContext {
	return &ServeContext{
		StaticSiteImage:  tool.GetToolImageWithDefault("static-site", "cli-static-site:latest"),
