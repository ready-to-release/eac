...
Examples:
  test eac-core
  test eac-core --suite unit
  test eac-core --suite unit+integration
`,
			wantDesc:     "test - Test one or more modules\n\nRuns tests for specified modules.",
			wantUsage:    "test [module...] [flags]",
			wantExamples: "test eac-core\n  test eac-core --suite unit\n  test eac-core --suite unit+integration",
			wantFlags:    1,
		},
		{
...
func TestDedentExamples(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input: "  build eac-core\n  build eac-commands",
			want:  "build eac-core\n  build eac-commands", // First line trimmed, second unchanged (minIndent=0)
		},
		{
		...
		},
		{
			...
			input: "build eac-core\n  build eac-core --dry-run",
			want:  "build eac-core\n  build eac-core --dry-run", // No dedent needed (minIndent=0)
		},
	}
