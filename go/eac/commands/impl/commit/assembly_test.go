...
func TestCombineCommitSections_Deduplication(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			moduleSections: []string{
				"eac-core\n--------\neac-core: feat: first change",
				"contracts\n---------\ncontracts: feat: update contracts",
				"eac-core\n--------\neac-core: feat: second change (duplicate)",
			},
			wantModules: []string{
				"eac-core",
				"contracts",
		...
		},
		{
			...
			moduleSections: []string{
				"eac-commands\n------------\neac-commands: feat: add command 1",
				"eac-commands\n------------\neac-commands: feat: add command 2",
				"eac-commands\n------------\neac-commands: feat: add command 3",
			},
			wantModules: []string{
				"eac-commands",
			},
