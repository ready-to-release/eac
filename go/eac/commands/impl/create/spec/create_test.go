...
// File: go/eac/commands/impl/create/spec/create_test.go
package spec
...
func TestParseConfig_Flags(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:       []string{"r2r", "specs", "create", "-m", "eac-commands", "Test description"},
		...
		},
		{
			...
			args:       []string{"r2r", "specs", "create", "--module", "eac-core", "Test description"},
			wantModule: "eac-core",
			wantDesc:   "Test description",
			wantErr:    false,
		},
