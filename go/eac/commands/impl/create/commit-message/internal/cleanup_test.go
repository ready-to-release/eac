...
eac-commands
------------
eac-commands: feat: add a really long feature description that exceeds the maximum allowed length
...
func TestWrapSemanticCommitLine(t *testing.T) {
	tests := []struct {
		...
		{
			name: "wrap long subject line",
			line: "eac-commands: feat: add a really long feature description that definitely exceeds the maximum allowed length",
			want: []string{
				"eac-commands: feat: add a really long feature description that",
				"definitely exceeds the maximum allowed length",
			},
		},
		{
			name: "preserve short subject line",
			line: "eac-commands: feat: add validation",
			want: []string{"eac-commands: feat: add validation"},
		},
	}
...
eac-commands
------------
eac-commands: feat: add commit message validation logic with contract checking.
...
eac-core
--------
eac-core: feat: add cleanup utilities
