...
feat(eac-commands): add commit validation

Body text here.`,
			agentType: "top-level",
			want: `feat(eac-commands): add commit validation
...
Body text here.`,
		},
		{
			...
			input: `feat(eac-core): add new provider

Body text here.`,
			agentType: "top-level",
			want: `feat(eac-core): add new provider
...
docs(eac-commands): update documentation

Body text here.`,
			agentType: "top-level",
			want: `docs(eac-commands): update documentation
...
feat(eac-commands): add feature

Body text here.`,
			agentType: "top-level",
			want: `feat(eac-commands): add feature
...
eac-core: refactor: simplify logic
