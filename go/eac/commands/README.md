...
- `github.com/ready-to-release/eac/go/eac/core/contracts/*` - Module contracts
- `github.com/ready-to-release/eac/go/eac/core/repository/*` - Repository operations
- `github.com/ready-to-release/eac/go/eac/commands/internal/render` - Markdown table rendering
