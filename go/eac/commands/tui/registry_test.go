...
func (m *mockConsole) StartModule(moniker string, weight int)                    {}
func (m *mockConsole) MarkModuleRunning(moniker string)                          {}
func (m *mockConsole) MarkModuleComplete(moniker string, exitCode int)           {}
func (m *mockConsole) MarkModuleCompleteWithCacheInfo(moniker string, exitCode int, cacheTime time.Time, logPath string) {
}
