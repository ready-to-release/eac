module github.com/ready-to-release/eac/go/eac/commands
...
require (
	...
	github.com/ready-to-release/eac/go/eac/adapters/ai v0.0.0
	github.com/ready-to-release/eac/go/eac/adapters/docker v0.0.0
	github.com/ready-to-release/eac/go/eac/adapters/tui v0.0.0
...
require (
	...
	github.com/ready-to-release/eac/contracts/eac-adapters-tui v0.0.0 // indirect
...
replace (
	github.com/ready-to-release/eac/contracts/eac-adapters-tui => ../../../contracts/eac-adapters/tui
	github.com/ready-to-release/eac/contracts/eac-core-interfaces => ../../../contracts/eac-core/0.1.0/interfaces
	github.com/ready-to-release/eac/go/eac/adapters/ai => ../adapters/ai
	github.com/ready-to-release/eac/go/eac/adapters/docker => ../adapters/docker
	github.com/ready-to-release/eac/go/eac/adapters/tui => ../adapters/tui
