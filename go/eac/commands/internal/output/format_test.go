...
func TestFormatComponentName(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want:      "eac-core:very-long-component-name-that-is-quite-lengthy",
		},
		{
...
func TestTruncateComponentName(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			module:    "eac-commands-module",
			component: "toolchain",
			maxWidth:  26,
			want:      "eac-commands-m...:toolchain",
		},
		{
...
func TestTruncateComponentName_LengthConstraint(t *testing.T) {
	...
	tests := []struct {
		...
		{"short module and component", "eac-core", "config", 20},
...
func TestTruncateComponentName_PreservesComponent(t *testing.T) {
	...
	tests := []struct {
		...
		{"short component preserved", "eac-commands-module", "cfg", 15},
	}
