...
All notable changes to **eac-ai** will be documented in this file.
...
- test(multi-module): expand validation framework
...
[Unreleased]: https://github.com/ready-to-release/eac/compare/eac-ai/0.0.2...HEAD
[0.0.2]: https://github.com/ready-to-release/eac/releases/tag/eac-ai/0.0.2
