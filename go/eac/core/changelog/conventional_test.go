...
func TestFilterCommitsByModule(t *testing.T) {
	commits := []*Commit{
		{SHA: "1", Files: []string{"go/r2r/cli/main.go"}},
		{SHA: "2", Files: []string{"go/eac/core/types.go"}},
		{SHA: "3", Files: []string{"docs/readme.md"}},
		{SHA: "4", Files: []string{"go/r2r/cli/config.go", "go/eac/core/utils.go"}},
	}

	// Filter for go/r2r/cli/**
	patterns := []string{"go/r2r/cli/**"}
...
func TestMatchGlobPattern(t *testing.T) {
	tests := []struct {
		...
		// Literal matches
		{"go/r2r/cli/main.go", "go/r2r/cli/main.go", true},
		{"go/r2r/cli/main.go", "go/eac/core/main.go", false},

		// ** patterns (prefix/**)
		{"go/r2r/cli/main.go", "go/r2r/cli/**", true},
		{"go/r2r/cli/internal/config.go", "go/r2r/cli/**", true},
		{"go/eac/core/main.go", "go/r2r/cli/**", false},

		// Note: **/*.go pattern is not supported by our simple matcher
		// Use the full gobwas/glob library if needed

		// * patterns
		{"go/r2r/cli/main.go", "go/r2r/cli/*.go", true},
		{"go/r2r/cli/internal/config.go", "go/r2r/cli/*.go", false}, // * doesn't match /
