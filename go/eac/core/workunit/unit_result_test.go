...
func TestUnitResult_LogPathIsAccessible(t *testing.T) {
	result := UnitResult{
		ID:       UnitID{Context: ContextBuild, Module: "eac-core", Component: "go", Tool: "go"},
		ExitCode: 0,
		LogPath:  "out/build/eac-core/go/execution.log",
	}

	assert.Equal(t, "out/build/eac-core/go/execution.log", result.LogPath)
}
...
func TestUnitResult_RealWorldScenarios(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			result: UnitResult{
				ID:       UnitID{Context: ContextTest, Module: "eac-core", Component: "go", Tool: "gotest", Extra: map[string]string{"testset": "unit"}},
				ExitCode: 1,
				Duration: 45 * time.Second,
				LogPath:  "out/test/eac-core/go/unit/execution.log",
		...
		},
		{
			...
			result: UnitResult{
				ID:       UnitID{Context: ContextLint, Module: "eac-core", Component: "go", Tool: "golangci-lint"},
				ExitCode: 0,
				Duration: 8 * time.Second,
				LogPath:  "out/lint/eac-core/go/execution.log",
		...
		},
		{
			...
			result: UnitResult{
				ID:       UnitID{Context: ContextScan, Module: "eac-core", Component: "go", Tool: "trivy-vuln"},
				ExitCode: 1,
				Duration: 30 * time.Second,
				LogPath:  "out/scan/eac-core/go/execution.log",
