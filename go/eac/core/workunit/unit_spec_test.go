...
func TestUnitSpec_FieldsExist(t *testing.T) {
	...
	assert.False(t, spec.IsContainer)
...
func TestNewBuildSpec_CreatesSpecWithContextBuild(t *testing.T) {
	spec := NewBuildSpec("eac-core", "go", "go")
...
func TestNewBuildSpec_SetsCorrectFields(t *testing.T) {
	...
	assert.Equal(t, "eac-core", spec.ID.Module)
...
func TestNewBuildSpec_SetsReasonableDefaults(t *testing.T) {
	...
	assert.False(t, spec.IsContainer, "IsContainer should default to false")
...
func TestNewTestSpec_CreatesSpecWithContextTest(t *testing.T) {
	spec := NewTestSpec("eac-core", "go", "gotest", "unit")
...
func TestNewLintSpec_CreatesSpecWithContextLint(t *testing.T) {
	spec := NewLintSpec("eac-core", "go", "golangci-lint")
...
func TestNewScanSpec_CreatesSpecWithContextScan(t *testing.T) {
	spec := NewScanSpec("eac-core", "go", "trivy-vuln")
...
func TestUnitSpec_DependsOnCanBeSet(t *testing.T) {
	buildSpec := NewBuildSpec("eac-core", "go", "go")
	testSpec := NewTestSpec("eac-core", "go", "gotest", "unit")
...
func TestUnitSpec_DependsOnMultiple(t *testing.T) {
	...
	dep1 := UnitID{Context: ContextBuild, Module: "eac-core", Component: "go", Tool: "go"}
...
// =============================================================================
// UnitSpec IsContainer Tests
// =============================================================================

func TestUnitSpec_IsContainerCanBeSet(t *testing.T) {
	spec := NewBuildSpec("eac-cli", "docker", "docker")
	spec.IsContainer = true

	assert.True(t, spec.IsContainer)
}
