...
type GoModInfo struct {
	...
	ModuleDir  string    // Relative directory (e.g., "go/r2r/cli")
...
type Require struct {
	Path     string // Module path (e.g., "github.com/ready-to-release/eac/go/eac/core")
...
type ModuleNode struct {
	...
	SourceRoot string   // Relative source root (e.g., "go/r2r/cli")
