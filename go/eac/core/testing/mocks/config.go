...
type MockConfig struct {
	...
	securityTools  interfaces.SecurityToolsConfigPort
...
// WithSecurityTools sets the security tools configuration.
func (m *MockConfig) WithSecurityTools(tools interfaces.SecurityToolsConfigPort) *MockConfig {
	m.securityTools = tools
	return m
}
...
// GetSecurityTools implements interfaces.ConfigPort.
func (m *MockConfig) GetSecurityTools() interfaces.SecurityToolsConfigPort {
	return m.securityTools
}
