...
func TestLoadTestingMocks_RealWorldScenarios(t *testing.T) {
  ...
  ai:
    enabled: true
    mock_dir: "go/eac/specs/impl/eac-commands/assets"
  security:
    enabled: true
  docker:
    enabled: true
  ...
  ai:
    enabled: false`,
			...
			want: TestingMocksConfig{
				Mocks: MocksConfig{
					AI:       AIMockConfig{Enabled: false, MockDir: "go/eac/specs/impl/eac-commands/assets"},
					Security: SecurityMockConfig{Enabled: true},
					Docker:   DockerMockConfig{Enabled: true},
					GitHub:   GitHubMockConfig{Enabled: true},
				},
  ...
  github:
    ...
    no_workflows: false`,
			...
			want: TestingMocksConfig{
				Mocks: MocksConfig{
					AI:       AIMockConfig{Enabled: true, MockDir: "go/eac/specs/impl/eac-commands/assets"},
					Security: SecurityMockConfig{Enabled: true, Tools: []string{}},
					Docker:   DockerMockConfig{Enabled: true},
					GitHub:   GitHubMockConfig{Enabled: true, NoWorkflows: false},
				},
