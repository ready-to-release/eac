...
// It searches up from the current package directory to find contracts/eac-core/0.1.0/testing-mocks.schema.json
func findSchemaPath() (string, error) {
	...
	// Walk up directory tree looking for contracts/eac-core/0.1.0/testing-mocks.schema.json
	dir := cwd
	for {
		schemaPath := filepath.Join(dir, "contracts", "eac-core", "0.1.0", "testing-mocks.schema.json")
	...
	return "", fmt.Errorf("testing-mocks.schema.json not found in contracts/eac-core/0.1.0/")
}
