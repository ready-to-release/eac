...
// GetModuleContracts loads and reports on all module domain.
...
// FormatReport returns a formatted string representation of the module domain.
...
// PrintSummary prints a concise summary of the loaded domain.
