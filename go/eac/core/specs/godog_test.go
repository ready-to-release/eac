// Package specs contains godog BDD test implementations for eac-core.
//
// This package runs all Gherkin specifications under specs/eac-core/ and provides
...
// TestEacCoreFeatures runs all eac-core Gherkin specifications.
// This is the single entry point for running all eac-core BDD tests.
func TestEacCoreFeatures(t *testing.T) {
	cfg := eacgodog.RunnerConfig{
		SpecsPath:         "../../../../specs/eac-core",
		DefaultReportName: "cucumber-eac-core",
...
// registerAllSteps registers all step implementations for eac-core features.
