...
func TestGherkinValidator_BasicStructure(t *testing.T) {
  ...
  Rule: Some rule`,
		...
		},
		{
			...
			input: `Feature: eac-core_first
Feature: eac-core_second
...
func TestGherkinValidator_FeatureNaming(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "valid: simple", featureName: "eac-core_test-feature", expectError: false},
		{name: "valid: with numbers", featureName: "eac-core2_test123", expectError: false},
