...
func TestModuleContract_GetGlobPatterns(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: []string{"go/r2r/cli/go.mod", "go/r2r/cli/**.go", "specs/r2r-cli/**"},
		},
	}
...
func TestModuleContract_MatchesFile_RepoSpecs(t *testing.T) {
	tests := []struct {
		...
		{"specs matches file", "go/r2r/cli", []string{"specs/r2r-cli/**"}, []string{"go.mod"}, "specs/r2r-cli/test.feature", true},
		{"specs matches nested", "go/r2r/cli", []string{"specs/r2r-cli/**"}, []string{"go.mod"}, "specs/r2r-cli/design/workspace.dsl", true},
		{"specs doesn't match other specs", "go/r2r/cli", []string{"specs/r2r-cli/**"}, []string{"go.mod"}, "specs/eac-core/test.feature", false},
		{"source pattern with specs", "go/r2r/cli", []string{"specs/r2r-cli/**"}, []string{"go.mod"}, "go/r2r/cli/go.mod", true},
	}
...
func TestModuleContract_GetDesignPath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			design:   "specs/eac-commands/.design",
			expected: "specs/eac-commands/.design",
		},
		{
