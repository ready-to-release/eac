...
All notable changes to **eac-mcp-commands** will be documented in this file.
...
- chore(eac-mcp-commands): reorganize design directory structure
...
[Unreleased]: https://github.com/ready-to-release/eac/compare/eac-mcp-commands/0.0.2...HEAD
[0.0.2]: https://github.com/ready-to-release/eac/releases/tag/eac-mcp-commands/0.0.2
