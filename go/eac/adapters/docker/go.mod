module github.com/ready-to-release/eac/go/eac/adapters/docker
...
replace (
	github.com/ready-to-release/eac/contracts/eac-adapters-docker => ../../../../contracts/eac-adapters/docker
