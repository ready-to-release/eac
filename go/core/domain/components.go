...
type ComponentEntry struct {
	...
	Config      map[string]string      `yaml:"config,omitempty" json:"config,omitempty"`         // Component-specific config (book, theme, etc.)
	DependsOn   []string               `yaml:"depends_on,omitempty" json:"depends_on,omitempty"` // Intra-module dependencies
