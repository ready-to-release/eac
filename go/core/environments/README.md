...
| File                  | Responsibility                                                       |
| --------------------- | -------------------------------------------------------------------- |
| constants.go          | App config, paths, Docker/container, build, and system `Env*` constants |
| constants_ci.go       | CI/CD platform detection and GitHub Actions metadata constants       |
| constants_testing.go  | Test infrastructure, BDD framework, and mock configuration constants |
