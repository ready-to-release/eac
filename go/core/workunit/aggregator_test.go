...
func TestNewUoWAggregator(t *testing.T) {
	t.Run("counts UoWs per module", func(t *testing.T) {
		expectedUoWs := []UnitID{
			{Action: ActionTest, Module: "core", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
			{Action: ActionTest, Module: "core", ComponentType: "gherkin", ComponentName: "gherkin", Tool: "godog"},
			{Action: ActionTest, Module: "cli", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
		}
...
func TestUoWAggregator_MarkCached(t *testing.T) {
	t.Run("increments cached count for module", func(t *testing.T) {
		...
		agg.MarkCached(UnitID{Action: ActionTest, Module: "core", ComponentType: "go", ComponentName: "go", Tool: "gotest"})
		...
		agg.MarkCached(UnitID{Action: ActionTest, Module: "core", ComponentType: "gherkin", ComponentName: "gherkin", Tool: "godog"})
...
func TestUoWAggregator_GetModuleLists(t *testing.T) {
	t.Run("separates modules into changed and up-to-date", func(t *testing.T) {
		expectedUoWs := []UnitID{
			...
			{Action: ActionTest, Module: "core", ComponentType: "gherkin", ComponentName: "gherkin", Tool: "godog"},
			{Action: ActionTest, Module: "cli", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
			{Action: ActionTest, Module: "api", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
		}
		...
		agg.MarkCached(UnitID{Action: ActionTest, Module: "cli", ComponentType: "go", ComponentName: "go", Tool: "gotest"})
	...
	t.Run("preserves order from expectedUoWs", func(t *testing.T) {
		expectedUoWs := []UnitID{
			{Action: ActionTest, Module: "zzz", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
			{Action: ActionTest, Module: "aaa", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
			{Action: ActionTest, Module: "mmm", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
		}
	...
	t.Run("deduplicates modules", func(t *testing.T) {
		expectedUoWs := []UnitID{
			{Action: ActionTest, Module: "core", ComponentType: "go", ComponentName: "go", Tool: "gotest"},
			{Action: ActionTest, Module: "core", ComponentType: "gherkin", ComponentName: "gherkin", Tool: "godog"},
			{Action: ActionTest, Module: "core", ComponentType: "ts", ComponentName: "ts", Tool: "jest"},
		}
