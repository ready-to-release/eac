	...
	tests := []struct {
		...
		},
		{
			...
			unitID: UnitID{
				Action:        core.ActionTest,
				Module:        "core",
				ComponentType: "cache-invalidation", ComponentName: "cache-invalidation",
				Tool: "godog",
...
func TestUnitID_Spec_TabLabel(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			u := UnitID{
				ComponentType: "complex-component-path", ComponentName: "complex-component-path",
				Spec: tt.spec,
			}
	...
	tests := []struct {
		...
		},
		{
			...
			unitID: UnitID{
				Action:        core.ActionBuild,
				Module:        "docs",
				ComponentType: "site", ComponentName: "site",
				Tool: "mkdocs",
			},
		...
		},
		{
			...
			unitID: UnitID{
				Action:        core.ActionBuild,
				Module:        "mcp",
				ComponentType: "typescript", ComponentName: "typescript",
				Tool: "npm",
			},
...
func TestUnitID_NormalDisplay_TestContext(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: "Testing spec build-module in eac",
		},
		{
...
func TestUnitID_NormalDisplay_UnknownContext(t *testing.T) {
	unitID := UnitID{
		Action:        "unknown",
		Module:        "mod",
		ComponentType: "comp", ComponentName: "comp",
		Tool: "tool",
	}
...
func TestUnitID_DisplayFormats_PlanExamples(t *testing.T) {
	examples := []struct {
		...
		// Test Context - BDD
		{
			...
			normal:      "Testing spec build-module in eac",
		},
		{
		...
		// Test Context - Unit
		{
			...
			normal:      "Testing impl-build in eac",
		},
		{
		...
		},
		{
			...
			unitID: UnitID{
				Action:        core.ActionBuild,
				Module:        "books",
				ComponentType: "pdf", ComponentName: "pdf",
				Tool: "pdf",
			},
