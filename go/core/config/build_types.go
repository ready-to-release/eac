...
// These define component-kind-level defaults for artifacts and Docker builds.
...
type DockerBuildConfig struct {
	...
	Builder    string             `yaml:"builder,omitempty"`    // Buildx builder name (default: auto-detected from active Docker context)
