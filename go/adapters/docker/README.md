...
### Pain Points
- serve.go is 714 lines; strong candidate for splitting (extract container lifecycle, health checks, and browser launch into separate files)
- container.go is 601 lines; candidate for splitting (extract retry logic, streaming, and execution into separate files)
- simple_mock_client.go is 354 lines; candidate for splitting by operation type
