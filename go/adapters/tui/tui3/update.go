...
func (m Model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case LayerUpdateMsg:
		m.SetLayer(msg.Current, msg.Total)
	...
	case ToolActiveMsg:
		if msg.IsContainer {
			m.activeContainers = addToSlice(m.activeContainers, msg.Name)
		} else {
	...
	case ToolInactiveMsg:
		if msg.IsContainer {
			m.activeContainers = removeFromSlice(m.activeContainers, msg.Name)
		} else {
