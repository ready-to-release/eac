module github.com/ready-to-release/eac/go/adapters/reqnroll

go 1.24.4

require (
	github.com/ready-to-release/eac/go/adapters/dotnet v0.0.0
	github.com/ready-to-release/eac/go/adapters/nuget v0.0.0
...
replace (
	...
	github.com/ready-to-release/eac/go/adapters/dotnet => ../dotnet
	github.com/ready-to-release/eac/go/adapters/nuget => ../nuget
