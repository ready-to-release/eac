module github.com/ready-to-release/eac/go/commands/test
...
require (
	...
	github.com/ready-to-release/eac/go/adapters/docker v0.0.0 // indirect
	github.com/ready-to-release/eac/go/adapters/eac v0.0.0 // indirect
	github.com/ready-to-release/eac/go/adapters/gh v0.0.0 // indirect
...
replace (
	...
	github.com/ready-to-release/eac/go/commands/repository => ../repository
