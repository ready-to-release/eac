...
// ScanCacheVerifier implements execution.CacheVerifier for scan commands.
// Uses UoW-level cache for fine-grained scan caching at component:scanner granularity.
type ScanCacheVerifier struct {
...
func (v *ScanCacheVerifier) Verify(ctx context.Context, unit workunit.UnitSpec) (execution.CacheResult, error) {
