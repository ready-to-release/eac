...
// File: go/cli/eac/impl/specs/security_test.go
package specs
...
func TestExtractFeatureName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			gherkin:    "Feature: eac-cli_user-authentication\n  As a user...",
			wantModule: "eac-cli",
...
func TestDetermineOutputPath(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantContain: []string{"specs", "eac-cli", "user-auth", "specification.feature"},
		},
		{
...
func TestExtractFeatureName_SpecialCharactersValidation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			gherkin:     "Feature: eac-cli_user-auth\n",
			wantModule:  "eac-cli",
			wantName:    "user-auth",
			wantErr:     false,
		...
		},
		{
			...
			gherkin:     "Feature: go/cli/eac/test\n",
			wantModule:  "",
			wantName:    "",
...
func TestExtractFeatureName_UnicodeNames(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "Mixed scripts",
			gherkin:     "Feature: clie_función-中文-test\n",
			wantModule:  "clie",
...
func TestExtractFeatureName_WindowsReservedNames(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			gherkin:    "Feature: clie_console-app\n",
			wantModule: "clie",
