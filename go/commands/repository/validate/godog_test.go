...
import (
	...
	speccmds "github.com/ready-to-release/eac/go/commands/repository/create/spec"
...
func TestFeatures(t *testing.T) {
	cfg := eacgodog.RunnerConfig{
		SpecsPath: "../../../../specs/eac_validate",
		DefaultReportName: "cucumber-specs",
		AssetsPath:        "go/commands/repository/validate/assets",
