...
// File: go/cli/eac/impl/validate/specs_test.go
package validate
...
func TestParseValidateConfig_Flags(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:       "simple path",
			args:       []string{"clie", "specs", "validate", "specs/test.feature"},
			wantFormat: "text",
			wantErr:    false,
		},
		{
			name:       "quiet flag short",
			args:       []string{"clie", "specs", "validate", "-q", "specs/test.feature"},
			wantQuiet:  true,
			wantFormat: "text",
			wantErr:    false,
		},
		{
			...
			args:       []string{"clie", "specs", "validate", "--quiet", "specs/test.feature"},
			wantQuiet:  true,
			wantFormat: "text",
			wantErr:    false,
		},
		{
			...
			args:        []string{"clie", "specs", "validate", "-v", "specs/test.feature"},
			wantVerbose: true,
			wantFormat:  "text",
			wantErr:     false,
		},
		{
			...
			args:        []string{"clie", "specs", "validate", "--verbose", "specs/test.feature"},
			wantVerbose: true,
			wantFormat:  "text",
			wantErr:     false,
		},
		{
			...
			args:       []string{"clie", "specs", "validate", "-f", "json", "specs/test.feature"},
			wantFormat: "json",
			wantErr:    false,
		},
		{
			name:       "format flag long text",
			args:       []string{"clie", "specs", "validate", "--format", "text", "specs/test.feature"},
			wantFormat: "text",
			wantErr:    false,
		},
		{
			name:       "fix flag",
			args:       []string{"clie", "specs", "validate", "--fix", "specs/test.feature"},
			wantFix:    true,
			wantFormat: "text",
			wantErr:    false,
		},
		{
			...
			args:        []string{"clie", "specs", "validate", "-q", "-v", "-f", "json", "--fix", "specs/test.feature"},
			wantQuiet:   true,
			wantVerbose: true,
			wantFormat:  "json",
			wantFix:     true,
		...
		{
			name:        "missing path",
			args:        []string{"clie", "specs", "validate"},
			wantErr:     true,
			errContains: "file path or directory is required",
		},
		{
			name:        "invalid format",
			args:        []string{"clie", "specs", "validate", "-f", "xml", "specs/test.feature"},
			wantErr:     true,
			errContains: "invalid format",
		},
		{
			name:        "format flag missing argument",
			args:        []string{"clie", "specs", "validate", "-f"},
			wantErr:     true,
...
func TestParseValidateConfig_CheckTags(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args:          []string{"clie", "specs", "validate", "--check-tags", "specs/test.feature"},
			wantCheckTags: true,
		},
		{
			name:          "no-check-tags disables",
			args:          []string{"clie", "specs", "validate", "--no-check-tags", "specs/test.feature"},
			wantCheckTags: false,
		},
	}
