...
// registerPruneSteps registers step definitions for release prune-packages features.
func registerPruneSteps(sc *godog.ScenarioContext, ctx *eacgodog.TestContext) {
