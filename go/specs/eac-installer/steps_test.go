// Package eacinstaller contains godog step implementations for specs/eac-installer.
//
// Features:
...
func initializeInstallerContext() {
	...
	instCtx.scriptsRoot = paths.BuildOutputPath(repoRoot, "eac-installer")
