...
// Long:
// Long: Example:
// Long:   get ci-dispatch-layers --modules "core r2r-cli ext-eac"
// Long:   get ci-dispatch-layers --modules "core r2r-cli ext-eac" --format shell
...
func printCIDispatchLayersUsage() {
	...
	fmt.Println("  r2r get ci-dispatch-layers --modules \"core r2r-cli ext-eac\"")
	fmt.Println("")
