// Package testview provides UoW-based test data aggregation.
// It reads test UoW manifests and their referenced artifact files
// to construct test result views by reading UoW manifests and their artifact files.
package testview
