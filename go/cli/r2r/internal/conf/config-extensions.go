...
func getActualImageVersion(image string) string {
	...
	if extensionName != "" {
		return fmt.Sprintf("run-XXX  # Check for stable versions at https://github.com/ready-to-release/eac/go/cli/r2r/pkgs/container/r2r-cli%%2Fextensions%%2F%s", extensionName)
	}
