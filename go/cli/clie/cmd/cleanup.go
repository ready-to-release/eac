...
import (
	...
	"github.com/ready-to-release/eac/go/cli/clie/internal/docker"
...
Use --containers to also clean up stopped containers.`,
  ...
  clie cleanup --containers

  # Clean only extension containers
  clie cleanup --containers --extensions-only

  # Clean containers older than 24 hours
  clie cleanup --containers --older-than 24h

  # Show what would be removed without actually removing
  clie cleanup --dry-run
