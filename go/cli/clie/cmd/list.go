  ...
  clie list --clear-cache`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		if hasUninstalled {
			...
			logging.Info("  clie install <name>")
		}

		// Show tips
		logging.Info("\n💡 Tips:")
		logging.Info("  • Use 'clie list --tags' to see all available tags")
		logging.Info("  • Use 'clie list --refresh' to update cache from registry")
		logging.Info("  • Use 'clie list --clear-cache' to clear cache without listing")
		logging.Info("  • Use 'clie install <name>' to add extensions with latest SHA")
	},
}
