// Package interfaces provides type definitions for tool configuration.
package interfaces
...
// This is the concrete implementation of ToolAssignmentPort.
...
func ComponentToNamespace(componentType string) Namespace {
	...
	case "go", "go-feature", "gherkin-steps":
		return NSGo
