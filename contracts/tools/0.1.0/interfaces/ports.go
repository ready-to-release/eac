// Package interfaces defines the tool configuration contract interfaces.
// These interfaces define how tools are configured, loaded, and accessed
// with support for namespace-based lazy loading.
package interfaces
...
type ToolConfigPort interface {
	...
	GetComponentTools(componentType string) (ToolAssignmentPort, bool)
