...
type ConfigPort interface {
	...
	GetSecurityTools() SecurityToolsConfigPort
...
// SecurityToolsConfigPort provides security tool configuration.
type SecurityToolsConfigPort interface {
	GetSkipModules() []string
	GetTrivyImage() string
	GetSemgrepImage() string
	GetZAPImage() string
}
