...
This document provides comprehensive documentation for the CLIE CLI configuration file (`clie.yml`).
...
| 2        | User-Specific Config  | `.clie/clie.local.yml`, `.clie/clie.personal.yml`, etc. |
| 3        | Repository Config     | `.clie/clie.yml`                                          |
...
| File                          | Purpose                                        |
| ----------------------------- | ---------------------------------------------- |
| `.clie/clie.local.yml`      | Local development overrides (highest priority) |
| `.clie/clie.personal.yml`   | Personal customizations                        |
| `.clie/clie.dev.yml`        | Development environment settings               |
| `.clie/clie.<username>.yml` | User-specific settings                         |

### Override Example

Base config (`.clie/clie.yml`):
...
Local override (`.clie/clie.local.yml`):
...
```text
contracts/clie/0.1.0/clie.schema.json
```
...
- [JSON Schema](./clie.schema.json) - Formal schema definition
